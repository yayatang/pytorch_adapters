...
def model_and_snapshot_creation():
    ...
    codebase = dl.GitCodebase(git_url='https://github.com/dataloop-ai/pytorch_adapters',
                              git_tag='master')
    model = project.models.create(model_name='ResNet-torch',
    ...
    bucket = dl.buckets.create(dl.BucketType.GCS,
                               ...
                               gcs_prefix='ResNet50')
    snapshot = model.snapshots.create(snapshot_name='resnset50-imagenet-pretrained',
                                      description='resnset50-imagenet-pretrained',
                                      dataset_id=None,
                                      is_global=True,
